          ...
          <div className="main-content">
            ...
            <div className="card project-card">
              ...
              <div className="projects-grid">
                ...
                <a href="https://github.com/sam131102/Data301-GroupProject-IndividualPart" className="project-icon" target="_blank" rel="noopener noreferrer">
                  <img src={`${process.env.PUBLIC_URL}/fifa.png`} alt="FIFA" />
                </a>
